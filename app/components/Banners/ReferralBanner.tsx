...
const ReferralBanner = () => {
    return (
        <div className='relative w-[49.35%] aspect-[176/109] rounded-lg overflow-hidden'>
            ...
            <div className='absolute text-white left-1/2 transform -translate-x-1/2 bottom-[9.17%] font-righteous text-[3.33vw] text-nowrap leading-[3.33vw]'>
                <p>HAVE REFERRAL</p>
                <p>CODE?</p>
            </div>
            <div className='absolute left-[45.83%] transform bottom-[9.17%] flex bg-[#170A3566] rounded-lg w-[14.51vw] aspect-[209/40] items-center'>
