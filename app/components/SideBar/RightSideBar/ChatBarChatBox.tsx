    ...
    return (
        <div>
            <div ref={chatBarRef} className='fixed w-[17.36vw] aspect-[125/27] bottom-0 right-0 bg-[#1A0938] border-t border-[#231744] rounded-tl-lg flex items-center justify-center'>
                <div className='w-[88%] aspect-[110/17] rounded-lg pl-[4.54%] bg-[#070123] flex'>
                    <input placeholder='Hello, guys!' className='w-full text-[0.83vw] h-full bg-[#070123] text-white text-sm outline-none focus:ring-0 rounded-lg' />
                    <div className='w-[4.54%] aspect-square shrink-0 flex items-center justify-center rounded-full'>
                        <Image src={`${basePath}/images/purple-smiley-image.png`} alt='Emote Button icon' layout='responsive' width={100} height={100} />
                    </div>
                    <div className='w-[10%] aspect-square shrink-0 flex items-center justify-center bg-[#9B34FD] rounded-lg'>
