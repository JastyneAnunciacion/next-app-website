            ...
            {temporaryList.map((item, i) => {
                return (
                    <button key={i} className='relative bg-[#170A35] w-[32.42%] aspect-[347/185] rounded-lg border border-[#231744] flex items-center justify-center'>
                        <Image className='absolute mix-blend-screen' src={`${basePath}/images/sports-quick-list-vs-image.png`} alt='VS Image' layout='responsive' width={100} height={100} />
                        <div className='absolute w-full h-full pl-[8.93%] pt-[9.25%] flex flex-col items-start'>
                            <div className='w-[23.34%] ml-[1.73%] aspect-square'>
                                <Image className='mix-blend-screen' src={`${basePath}/images/md-barcelona-icon.png`} alt='Team Icon Image' layout='responsive' width={100} height={100} />
                            </div>
                        ...
                        <div className='absolute bg-[#2E1E51] top-[2.59%] w-[13.25%] aspect-[23/11] flex items-center justify-center gap-[10.87%] rounded-lg'>
                            <div className='w-[21.74%] aspect-square'>
                                <Image className='mix-blend-screen' src={`${basePath}/images/sports-quick-list-temporary-timer-image.png`} alt='Team Icon Image' layout='responsive' width={100} height={100} />
                            </div>
                        ...
                        <div className='absolute bg-[#2E1E51] top-[5.40%] right-[2.88%] w-[7.78%] aspect-[27/26] flex items-center justify-center gap-[10.87%] rounded-lg'>
                            <div className='w-[40.74%] aspect-[11/10]'>
                                <Image className='mix-blend-screen' src={`${basePath}/images/sm-purple-heart-image.png`} alt='Timer Icon Image' layout='responsive' width={100} height={100} />
                            </div>
                        </div>
                    </button>
                );
