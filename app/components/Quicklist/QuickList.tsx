    ...
    <div className='flex flex-col gap-2'>
      <div className='flex items-center justify-between w-full'>
        ...
        <div className='flex items-center text-white'>
          {viewAllLink && (
            <Link href={viewAllLink} className='w-16 h-6 bg-orange-700 text-xs rounded-lg mr-2 flex items-center justify-center'>
              View All
            </Link>
          )}

          <button onClick={() => scrollTo('left')} className='w-6 h-6 bg-orange-700 text-xs rounded-lg mr-2'>
            <Image src={`${basePath}/images/left-arrow-image.png`} alt="Left Arrow" width={30} height={30} />
          </button>
          <button onClick={() => scrollTo('right')} className='w-6 h-6 bg-orange-700 text-xs rounded-lg mr-2'>
